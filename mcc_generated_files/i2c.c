...
void I2C_Initialize(void)
{
    ...
    // BF RCinprocess_TXcomplete; UA dontupdate; SMP High Speed; P stopbit_notdetected; S startbit_notdetected; R_nW write_noTX; CKE Idle to Active; D_nA lastbyte_address; 
    SSPSTAT = 0x00;
